...
# Use this line for longout and longin records on older versions of EPICS base. 
# Limits GenICam Integer features to 52 bits because ao records with 64-bit floats are used.
